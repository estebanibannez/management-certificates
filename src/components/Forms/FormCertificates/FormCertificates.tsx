          ...
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              <h3 className="text-slate-900 dark:text-white mt-5 text-base font-medium tracking-tight">
                Mantenedor{" "}
                <span className="text-indigo-800 text-lg">Certificados</span>
              </h3>
              <p className="text-slate-500 dark:text-slate-400 mt-2 text-sm">
                Herramienta para la carga de imagenes de certificados.
              </p>
            </div>
          </div>
          <div className="mt-5 md:mt-0 md:col-span-2">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="sm:rounded-md sm:overflow-hidden ring-1 ring-slate-900/5 shadow-xl">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <textarea
                        ...
                        placeholder="Certificado de Graphql"
                        defaultValue={""}
                      />
                      {errors.description && (
                    ...
                    <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
                      Indica alguna descripción para el certificado.
                    </p>
                  </div>
